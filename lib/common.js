...
PaymentProtocol.LEGACY_PAYMENT.BTC.REQUEST_CONTENT_TYPE = 'application/potcoin-paymentrequest';
PaymentProtocol.LEGACY_PAYMENT.BTC.CONTENT_TYPE = 'application/potcoin-payment';
PaymentProtocol.LEGACY_PAYMENT.BTC.ACK_CONTENT_TYPE = 'application/potcoin-paymentack';
...
function magicHash(str) {
  var magicBytes = new Buffer('Potcoin Signed Message:\n');
